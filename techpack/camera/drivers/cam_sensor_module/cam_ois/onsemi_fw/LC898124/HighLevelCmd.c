...
//	SetTransDataAdr124( SinWave_OutAddr	,	(UINT32)SinWave_Output ) ;		// �����l�̏o�͐�A�h���X�́A�����̃����o
...
//	SetTransDataAdr124( CosWave_OutAddr	,	(UINT32)CosWave_Output );		// �����l�̏o�͐�A�h���X�́A�����̃����o
...
//TRACE("GY_AVEOFT = %08xh \n",(unsigned int)SlMeasureAveValueB) ;
		// X
		UsGxoVal[UcCnt] = (UINT16)( SlMeasureAveValueA >> 16 );	// ���ϒl����
		
		// Y
		UsGyoVal[UcCnt] = (UINT16)( SlMeasureAveValueB >> 16 );	// ���ϒl����
...
////////// ////////// ////////// ////////// //////////
	...
	RamWrite32A( CMD_GYRO_WR_ACCS , 0x1B180000 );		/* FS_SEL=3�Œ� & Disable Self Test */
	UcStRd = 1;
	while( UcStRd ) {
		UcStRd = RdStatus124(1);
	}
...
////////// ////////// ////////// ////////// //////////
	...
	RamWrite32A( CMD_GYRO_WR_ACCS , 0x1BD80000 );		/* FS_SEL=3�Œ� & Enable Self Test */
	UcStRd = 1;
	while( UcStRd ) {
		UcStRd = RdStatus124(1);
	}
...
//TRACE("UsGyrYval = %04x\n", UsGyrYval ) ;
	...
	RamWrite32A( CMD_GYRO_WR_ACCS , 0x1B000000 | ( UlGyroConfig >> 8));		/* ���̐ݒ�l�ɖ߂� */
	UcStRd = 1;
	while( UcStRd ) {
		UcStRd = RdStatus124(1);
	}
...
// History			: First edition
//********************************************************************************
/*  bit7  	HX GYR			Hall X  �Ɠ�������Gyro�M����GX?               0:GX  1:GY  */
/*  bit6  	HX GYR pol		Hall X+ �Ɠ�������Gyro�M����X+��G+�œ�����?   0:NEG 1:POS */
/*  bit5  	HY GYR pol		Hall Y+ �Ɠ�������Gyro�M����Y+��G+�œ�����?   0:NEG 1:POS */
/*  bit4  	GZ pol			��{�ɐ��ɑ΂���GyroZ�M����������?            0:NEG 1:POS */
/*  bit3  	HX ACL			Hall X  �Ɠ�������Accl�M����AX?               0:AX  1:AY  */
/*  bit2  	HX ACL pol		Hall X+ �Ɠ�������Accl�M����X+��A+�œ�����?   0:NEG 1:POS */
/*  bit1  	HY ACL pol		Hall Y+ �Ɠ�������Accl�M����Y+��A+�œ�����?   0:NEG 1:POS */
/*  bit0  	AZ pol			��{�ɐ��ɑ΂���AcclZ�M����������?            0:NEG 1:POS */
                      //   top0��btm0��//
